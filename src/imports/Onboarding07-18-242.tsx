import svgPaths from "./svg-urh9ysbrfe";
...
function Frame2() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[16px] top-[108px] w-[361px]">
      <p className="font-['Euclid_Circular_B:SemiBold',sans-serif] leading-[28px] min-w-full not-italic relative shrink-0 text-[#1c2329] text-[20px] w-[min-content]">{`I’d like to learn how to manage my emotions more effectively, and to improve my own relationships with friends, family, and my partner. `}</p>
      <Frame1 />
      <div className="font-['Sora:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#1c2329] text-[14px] w-[361px]">
