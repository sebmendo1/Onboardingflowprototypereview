import svgPaths from "./svg-sjaa8zxusq";
...
function AudioWaves() {
  return (
    <div className="absolute h-[53px] left-1/2 top-[calc(50%+0.5px)] translate-x-[-50%] translate-y-[-50%] w-[80px]" data-name="Audio-Waves">
...
function OnboardingPromptIndicator() {
  return (
    <div className="absolute left-[calc(50%+0.5px)] size-[240px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="Onboarding-Prompt-Indicator">
      <div className="absolute left-0 rounded-[1000px] size-[240px] top-0" style={{ backgroundImage: "linear-gradient(169.088deg, rgb(167, 127, 219) 1.886%, rgb(87, 33, 156) 99.181%)" }} />
      <AudioWaves />
    </div>
  );
}
