import svgPaths from "./svg-d1ck4x93mr";
    ...
    <div className="absolute left-[16px] size-[40px] top-[36px]">
      <div className="absolute inset-[-10%_-20%_-30%_-20%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 56 56">
          <g id="Group 44">
            <g filter="url(#filter0_d_1_142)" id="Ellipse 7">
...
export default function Onboarding() {
  return (
    <div className="bg-[#f6f6f6] overflow-clip relative rounded-[32px] size-full" data-name="Onboarding / 02">
      ...
      <Fab />
      <div className="absolute left-[calc(50%+0.5px)] rounded-[1000px] size-[180px] top-1/2 translate-x-[-50%] translate-y-[-50%]" style={{ backgroundImage: "linear-gradient(169.088deg, rgb(167, 127, 219) 1.886%, rgb(87, 33, 156) 99.181%)" }} />
      <Group />
      <Fab1 />
    </div>
  );
